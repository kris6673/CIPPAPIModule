...
The resource capacity for the room mailbox. This parameter is optional.
 ...
 #### EXAMPLE 1
```powershell
PS > Add-RoomMailbox -CustomerTenantID "7e3effb6-6efe-42f2-b071-48ce318eaf95" -DisplayName "Conference Room 1" -Domain "example.com" -Username "confroom1" -ResourceCapacity 10
```
